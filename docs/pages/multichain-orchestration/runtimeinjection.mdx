...
For advanced usage and additional functions, see the [API Reference](/reference/runtime-values).# Runtime Parameter Injection
...
```javascript
import { runtimeERC20BalanceOf, greaterThanOrEqualTo } from "@biconomy/abstractjs-canary";
