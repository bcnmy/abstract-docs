...
In order to trigger the Smart EOA flow, the user must - in a single signature - sign *both*
the "transfer funds to SCA" transaction _and_ the "execute required instructions" transaction.
