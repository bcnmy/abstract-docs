...
```bash [npm]
npm @biconomy/abstractjs viem @rhinestone/module-sdk
```
 
```bash [pnpm]
pnpm @biconomy/abstractjs viem @rhinestone/module-sdk
```
 
```bash [bun]
bun @biconomy/abstractjs viem @rhinestone/module-sdk
```
