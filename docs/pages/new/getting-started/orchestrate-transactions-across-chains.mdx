...
* **Multichain Nexus Account** (see [EIP‑7702 guide](./eip-7702-gasless))
* **Runtime Value Injection** for exact amounts (see [Runtime Injection](./runtime-injection))
* **Fusion trigger** (`transferToNexusTrigger`) to kick‑off execution
...
* **Fusion triggers** are covered in [Fusion Mode Basics](./fusion-basics)
* **Runtime values & constraints** are detailed in [Runtime Injection](./runtime-injection)
* **Gas abstraction** details in [EIP‑7702 guide](./eip-7702-gasless)
