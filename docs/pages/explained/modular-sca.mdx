...
:::tip[Choose Nexus as your smart account]
...
[Learn More About Nexus](/legacy/overview)
:::

## Smart Account Modules

Smart accounts compliant with the [ERC7579]() standard enable developers to 
install Account Modules and add extra functionality to their users accounts.

Our AbstractJS SDK makes [installing and managing account modules]() easy.
