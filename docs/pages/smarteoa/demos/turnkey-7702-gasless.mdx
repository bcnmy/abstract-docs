# EIP-7702 Gasless Transactions with Turnkey and Biconomy

In this guide, we demonstrate using Biconomy's AbstractJS together with Turnkey to enable your users to send gasless (sponsored) transactions using EIP-7702.
...
You've now learned how to use Biconomy's AbstractJS with Turnkey to enable EIP-7702 gasless transactions. This implementation provides:
...
4. Using Biconomy's MEE client for gasless and cross-chain transactions

This approach provides enterprise-grade security while maintaining the user experience benefits of gasless transactions across multiple chains.