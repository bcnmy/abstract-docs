...
```bash [npm]
npm install @web3auth/modal @web3auth/base @biconomy/abstractjs viem @web3auth/ethereum-provider
```

```bash [pnpm]
pnpm add @web3auth/modal @web3auth/base @biconomy/abstractjs viem @web3auth/ethereum-provider
```

```bash [yarn]
yarn add @web3auth/modal @web3auth/base @biconomy/abstractjs viem @web3auth/ethereum-provider
```

```bash [bun]
bun add @web3auth/modal @web3auth/base @biconomy/abstractjs viem @web3auth/ethereum-provider
```
