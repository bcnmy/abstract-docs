...
[Learn How Supertransactions Work](/mee/mee)
...
#### Wait for the Execution Reciept
...
```ts
const reciept = await waitForSupertransactionReceipt(meeClient, {
  hash: hash,
});
```
