...
Additionally, what sets AbstractJS apart is its support for both smart accounts and EOAs. Through [Fusion transactions](), 
...
![AbstractJS](https://i.imgur.com/hJbBCCy.png)
...
- [Chain Abstracted Applications Guide](/mee/tutorials/build-chainabstracted-app)
- [Intent Execution Documentation](/mee/tutorials/execute-intent)
- [Gas Sponsorship Implementation](/tutorials/gasless)
- [Cross-Chain Gas Guide](/mee/tutorials/pay-gas-across-chains)
- [Account Module Management](/modules/validators)

Source code is available on our [GitHub Repository](https://google.com).

:::tip
This documentation highlights key features but isn't exhaustive. Explore the API reference and tutorials for complete coverage.
:::